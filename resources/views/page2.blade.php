...
@section('container')
      ...
      <nav class="container py-4 mb-2 my-lg-3" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item">
            <a href="/presentation/page3/norskyentreprise">page 3</a>
          </li>
        </ol>
      </nav>
      ...
      <section class="container pb-5 mb-md-2 mb-lg-4">
        <h1 class="border-bottom pb-4 text-center">Qui Sommes Nous</h1>
        ...
        <div class="bg-secondary rounded-3 py-5 px-3 px-md-0">
          <div class="row justify-content-center mb-2 py-md-2 py-lg-4">
            <div class="col-lg-10 col-md-11">
              <h2 class="pb-3">Nos Performances</h2>
                  ...
                  <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                    <div class="card-body d-flex align-items-center">
                      ...
                      <div class="ps-4 ms-lg-3">
                        ...
                        <p class="mb-0"><span class="fw-semibold">Nos Professionnels</span> à distance</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                    <div class="card-body d-flex align-items-center">
                      ...
                      <div class="ps-4 ms-lg-3">
                        ...
                        <p class="mb-0"><span class="fw-semibold">Demandes </span> par semaine</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                    <div class="card-body d-flex align-items-center">
                      ...
                      <div class="ps-4 ms-lg-3">
                        ...
                        <p class="mb-0"><span class="fw-semibold">Nouveaux clients</span> par mois</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card h-100 border-0 shadow-sm p-md-2 p-lg-4">
                    <div class="card-body d-flex align-items-center">
                      ...
                      <div class="ps-4 ms-lg-3">
                        ...
                        <p class="mb-0"><span class="fw-semibold">Nombre de pays</span> utilisant notre produit </p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section class="container pb-5 mb-2 mb-md-4 mb-lg-5 mt-n2">
        <div class="d-flex align-items-center justify-content-between pb-4 mb-2">
          <h2 class="h1 mb-0">Nous sommes puissants</h2>
          ...
          <div class="col-md-5">
            <a href="https://www.youtube.com/watch?v=zPo5ZaH6sW8" class="gallery-item video-item is-hovered rounded-3" data-sub-html='<h6 class="fs-sm text-light">Silicon Inc. Showreel by Marvin McKinney</h6>'>
              ...
              <div class="gallery-item-caption p-4">
                <h4 class="text-light mb-1">PDG Norskyentreprise</h4>
      ...
      <section class="container pb-3 pb-lg-5 mb-3 mb-xl-4">
        <h2 class="text-center pb-md-2">Reconnu par les plus grandes entreprises</h2>
          ...
          <div class="col-md-5 mb-4 mb-md-0">
            <div class="card justify-content-center bg-dark h-100 p-4 p-lg-5">
              <div class="p-2">
                ...
                <h2 class="text-light pb-5 mb-2">
                Clients déjà servis</h2>
      ...
      <section class="container-fluid pt-lg-2 pb-5 mb-2 mb-md-4 mb-lg-5">
        <h2 class="h1 text-center pb-md-1 mb-1 mb-sm-3">
        Nos dirigeants</h2>
        <div class="swiper mx-0 mb-md-n2 mb-xxl-n3" data-swiper-options='{
          "slidesPerView": 1,
          "spaceBetween": 8,
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide py-3">
              <div class="card card-body card-hover bg-light border-0 text-center mx-2">
                ...
                <div class="d-flex justify-content-center">
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-facebook btn-sm me-2" aria-label="Facebook">
                    <i class="bx bxl-facebook"></i>
                  </a>
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-linkedin btn-sm me-2" aria-label="LinkedIn">
                    <i class="bx bxl-linkedin"></i>
                  </a>
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-twitter btn-sm" aria-label="Twitter">
            ...
            <div class="swiper-slide py-3">
              <div class="card card-body card-hover bg-light border-0 text-center mx-2">
                ...
                <div class="d-flex justify-content-center">
                  ...
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-stack-overflow btn-sm me-2" aria-label="Stack Overflow">
                    <i class="bx bxl-stack-overflow"></i>
                  </a>
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-github btn-sm" aria-label="GitHub">
            ...
            <div class="swiper-slide py-3">
              <div class="card card-body card-hover bg-light border-0 text-center mx-2">
                ...
                <div class="d-flex justify-content-center">
                  ...
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-dribbble btn-sm me-2" aria-label="Dribbble">
                    <i class="bx bxl-dribbble"></i>
                  </a>
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-linkedin btn-sm" aria-label="LinkedIn">
                    <i class="bx bxl-linkedin"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="swiper-slide py-3">
              <div class="card card-body card-hover bg-light border-0 text-center mx-2">
                ...
                <div class="d-flex justify-content-center">
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-instagram btn-sm me-2" aria-label="Instagram">
            ...
            <div class="swiper-slide py-3">
              <div class="card card-body card-hover bg-light border-0 text-center mx-2">
                ...
                <div class="d-flex justify-content-center">
                  ...
                  <a href="#" class="btn btn-icon btn-outline-secondary btn-behance btn-sm" aria-label="Behance">
        ...
        <div class="position-relative bg-secondary rounded-3 py-5 mb-2">
          <div class="row pb-2 py-md-3 py-lg-5 px-4 px-lg-0 position-relative zindex-3">
            <div class="col-xl-3 col-lg-4 col-md-5 offset-lg-1">
              <p class="lead mb-2 mb-md-3">Prêt à commencer?</p>
              <h2 class="h1 pb-3">N'hésitez pas à nous contacter</h2>
            </div>
            <form class="col-lg-6 col-md-7 offset-xl-1 needs-validation" novalidate>
              ...
              <button type="submit" class="btn btn-primary shadow-primary btn-lg">Envoyez</button>
            </form>
          </div>
