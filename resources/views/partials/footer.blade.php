        ...
        <div class="card border-0 bg-gradient-primary">
          <div class="card-body p-md-5 p-4 bg-size-cover" style="background-image: url(assets/img/landing/digital-agency/contact-bg.png);">
            <div class="py-md-5 py-4 text-center">
              <h3 class="h4 fw-normal text-light opacity-75">Voulez-vous travailler avec nous? Parlons</h3>
              <a href="mailto:email@example.com" class="display-6 text-light">Norskyentreprise@gmail.com</a>
              <div class="pt-md-5 pt-4 pb-md-2">
                <a href="contacts-v1.html" class="btn btn-lg btn-light">Nous Contacter</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <!-- Footer -->
  <footer class="footer bg-dark pt-5 pb-4 pb-lg-5 mt-2 mt-md-0">
      <div class="container pt-lg-4">
        <div class="row pb-5">
          <div class="col-lg-4 col-md-6">
            <div class="navbar-brand text-dark p-0 me-0 mb-3 mb-lg-4">
              <img src="/../assets/img/logo1.png" width="47%" alt="Image du logo">
              ...
              <div class="col-lg-4">
                ...
                <div id="useful-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                  <ul class="nav flex-column pb-lg-1 mb-lg-3">
                    <li class="nav-item"><a href="/" class="nav-link d-inline-block px-0 pt-1 pb-2">Accueil</a></li>
                    <li class="nav-item"><a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">NosServices</a></li>
                    <li class="nav-item"><a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">Nos Travaux</a></li>
                    <li class="nav-item"><a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">A Propos </a></li>
              ...
              <div class="col-xl-4 col-lg-3">
                ...
                <div id="social-links" class="collapse d-lg-block" data-bs-parent="#footer-links">
                  <ul class="nav flex-column mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a href="#" class="nav-link d-inline-block px-0 pt-1 pb-2">WhatsApp</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-xl-4 col-lg-5 pt-2 pt-lg-0">
                <h6 class="mb-2">Nous Contacter</h6>
                <a href="mailto:Norskyentreprise@gmail.com" class="fw-medium">email@example.com</a>
              </div>
            </div>
          </div>
        </div>
        <p class="nav d-block fs-xs text-center text-md-start pb-2 pb-lg-0 mb-0">
          &copy; Tous droits réservés. Faite par
          <a class="nav-link d-inline-block p-0" href="#" target="_blank" rel="noopener">NorskyJr</a>
        </p>
      </div>
    </footer>